...
public class KODCoursesAPIDbContext :
    AbpDbContext<KODCoursesAPIDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public KODCoursesAPIDbContext(DbContextOptions<KODCoursesAPIDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(KODCoursesAPIConsts.DbTablePrefix + "YourEntities", KODCoursesAPIConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
