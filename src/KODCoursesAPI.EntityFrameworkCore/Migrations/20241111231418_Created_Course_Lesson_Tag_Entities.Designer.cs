...
namespace KODCoursesAPI.Migrations
{
    ...
    [Migration("20241111231418_Created_Course_Lesson_Tag_Entities")]
    partial class Created_Course_Lesson_Tag_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KODCoursesAPI.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KODCoursesAPI.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KODCoursesAPI.Entities.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KODCoursesAPI.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KODCoursesAPI.Entities.Lesson", b =>
                {
                    b.HasOne("KODCoursesAPI.Entities.Course", "Course")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("LessonTag", b =>
                {
                    b.HasOne("KODCoursesAPI.Entities.Lesson", null)
                        .WithMany()
                        .HasForeignKey("LessonsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KODCoursesAPI.Entities.Tag", null)
                        .WithMany()
