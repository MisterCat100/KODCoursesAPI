...
public class KODCoursesAPIDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public KODCoursesAPIDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
